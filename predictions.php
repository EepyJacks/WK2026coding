...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($_POST['predictions'] ?? [] as $match_id => $scores) {
        ...
        // Niet ingevuld → overslaan
        if ($home === '' || $away === '') {
            continue;
        }

        // Alleen gehele getallen toestaan
        if (
            !ctype_digit((string)$home) ||
            !ctype_digit((string)$away)
        ) {
            continue;
        }
...
<div class="container">
    <div class="page-header">
        <div>
            ...
            <p class="page-desc">
                Vul per wedstrijd je voorspelde eindstand in.
                Lege velden worden genegeerd. Je kunt je
                voorspellingen later nog aanpassen.
            </p>
        </div>
    </div>
    ...
    <?php if (empty($matches)): ?>
        <div class="empty">
            ...
            <p class="empty-text">
                Zodra TODO 1 is afgemaakt zie je hier
                alle wedstrijden verschijnen.
            </p>
        </div>
    <?php else: ?>
                        ...
                        <div class="match-row">
                            ...
                            <div class="team team-home">
                                ...
                                <span class="team-flag">
                                    <?= strtoupper(substr($match['home_team'], 0, 2)) ?>
                                </span>
                            </div>
                            ...
                            <div class="team">
                                <span class="team-flag">
                                    <?= strtoupper(substr($match['away_team'], 0, 2)) ?>
                                </span>
